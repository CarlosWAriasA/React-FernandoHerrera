...
export const SearchControls = () => {
  ...
  const activeAccordion = searchParams.get("advanced-filters") === "true";
        ...
        <div className="flex gap-2">
          <Button
            ...
            onClick={() => {
              setSearchParams((prev) => {
                const previousValue =
                  prev.get("advanced-filters") == "true" ? "false" : "true";
                prev.set("advanced-filters", previousValue);
                return prev;
              });
            }}
          >
